class SettingsService
  ...
  DEFINITIONS = {
    ...
    decypharr_debrid_provider: { type: "string", default: "", category: "download", description: "Exact Decypharr debrid provider name to use for torrent submissions. Leave blank to let Decypharr choose." },
