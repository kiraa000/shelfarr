...
class DownloadClients::DecypharrTest < ActiveSupport::TestCase
  setup do
    ...
    Setting.where(key: "decypharr_debrid_provider").delete_all
  end
  ...
  test "sends configured Decypharr debrid provider with torrent submissions" do
    VCR.turned_off do
      SettingsService.set(:decypharr_debrid_provider, "realdebrid")
